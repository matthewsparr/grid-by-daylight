...
if __name__ == '__main__':
    env = gym.make('GDY-dbd-v0', global_observer_type=gd.ObserverType.SPRITE_2D, image_path='C:/Users/Matthew/Desktop/griddly/sprites') #  ISOMETRIC SPRITE_2D
    ...
    for s in range(10000):
        ...
        for player in range(1,6):
            ...
            # actions.append(np.array([1,4]))
        obs, reward, done, info = env.step(actions)
        state = env.get_state()
        # if s>10:
        #     print([i for i in state['Objects'] if i['Name']=='player'])
        #     break
